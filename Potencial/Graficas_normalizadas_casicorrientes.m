...
%% Cargar datos
data = load('240625b.dat');   % Cambiá el nombre si hace falta
x = data(:,1);
y = -data(:,2)*1000;
...
title('Mediciones del Potencial en Papel Whatman')
...
% xlim([0 250])
ylabel('Potencial [mV]');
title('Media ± Desviación Estándar - Potencial en Papel Whatman');
