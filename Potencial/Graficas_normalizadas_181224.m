...
%% Cargar datos
data = load('181224a.dat');   % Cambiá el nombre si hace falta
x = data(:,1);
y = data(:,2)*1000;
...
xlabel('Tiempo [s]')
ylabel(['Voltaje [mV]'])
legend('Medición 2','Medición 3','Medición 4','Medición 5','Medición 6')
title('Medicions de 181224a (20mA -6 µm)')
...
xlabel('Tiempo [s]');
ylabel('Potencial [mV]');
title('Media ± Desviación Estándar - Potencial en SP - 60% - 6 \mu m');
