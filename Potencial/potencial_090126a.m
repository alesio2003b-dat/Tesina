...
% Cargar los datos
datos = load('090126a.dat');
tiempo = datos(:,1);
amplitud = datos(:,2)*1000;

% Zona donde se miden los espectros (10x)
nombre_imagen = 'Papel_090126a.jpeg';
img = imread(nombre_imagen);
figure; imshow(img);
title('Posición de Espectros - 090126a (10x)');
...
yl = ylim;
text(tiempo(1), yl(2), '050126d (20 mA - 5 µm); 10x; Espectros fijo', 'VerticalAlignment','top', 'HorizontalAlignment','left');
