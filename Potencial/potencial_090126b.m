...
% Cargar los datos
datos = load('090126b.dat');
tiempo = datos(:,1);
amplitud = datos(:,2)*1000;

% Zona donde se miden los espectros (10x)
nombre_imagen = 'Papel_090126b.jpeg';
img = imread(nombre_imagen);
figure; imshow(img);
title('Posición de Espectros - 090126b (10x)');
...
yl = ylim;
text(tiempo(1), yl(2), '050126d (20 mA - 5 µm); 5x; Espectros un Punto', 'VerticalAlignment','top', 'HorizontalAlignment','left');
