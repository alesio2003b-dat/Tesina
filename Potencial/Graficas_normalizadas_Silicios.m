...
%% Cargar datos
data = load('010925a.dat');   % Cambiá el nombre si hace falta
x = data(:,1);
y = -data(:,2)*1000;
...
xlabel('Tiempo [s]')
ylabel(['Voltaje [mV]'])
legend('Medición 2','Medición 3','Medición 4','Medición 5')
title('Medicions del Potencial en Silicio Cristalino')
...
% Curva media
plot(x_common, Y_mean, 'k', 'LineWidth', 2.5);
...
xlabel('Tiempo [s]');
ylabel('Potencial [mV]');
title('Media ± Desviación Estándar - Potencial en Silicio Cristalino');
